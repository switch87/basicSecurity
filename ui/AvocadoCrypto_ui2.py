...
#
# Created: Thu Dec 17 15:31:41 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ButtonEncrypt.setGeometry(QtCore.QRect(330, 260, 81, 27))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 10, 231, 321))
        self.groupBox_2.setObjectName("groupBox_2")
        self.tabWidget = QtGui.QTabWidget(self.groupBox_2)
        self.tabWidget.setGeometry(QtCore.QRect(0, 30, 231, 251))
        ...
        self.ButtonSwitchRsa.setObjectName("ButtonSwitchRsa")
        self.tabWidget.addTab(self.tabTools, "")
        self.tabRsa = QtGui.QWidget()
        self.tabRsa.setObjectName("tabRsa")
        self.groupBoxOwnAes = QtGui.QGroupBox(self.tabRsa)
        ...
        self.lineOwnPrivate.setEnabled(False)
        ...
        self.lineOwnPublic.setEnabled(False)
        ...
        self.groupBoxResAes = QtGui.QGroupBox(self.tabRsa)
        self.groupBoxResAes.setGeometry(QtCore.QRect(0, 100, 221, 101))
        self.groupBoxResAes.setObjectName("groupBoxResAes")
        self.lineResPrivate = QtGui.QLineEdit(self.groupBoxResAes)
        self.lineResPrivate.setEnabled(False)
        self.lineResPrivate.setGeometry(QtCore.QRect(80, 20, 131, 27))
        self.lineResPrivate.setObjectName("lineResPrivate")
        self.lineResPublic = QtGui.QLineEdit(self.groupBoxResAes)
        self.lineResPublic.setEnabled(False)
        self.lineResPublic.setGeometry(QtCore.QRect(80, 60, 131, 27))
        self.lineResPublic.setObjectName("lineResPublic")
        self.label_3 = QtGui.QLabel(self.groupBoxResAes)
        self.label_3.setGeometry(QtCore.QRect(20, 30, 56, 17))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtGui.QLabel(self.groupBoxResAes)
        self.label_4.setGeometry(QtCore.QRect(20, 70, 56, 17))
        self.label_4.setObjectName("label_4")
        self.tabWidget.addTab(self.tabRsa, "")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ButtonDecrypt.setText(QtGui.QApplication.translate("Dialog", "Decrypt", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonEncrypt.setText(QtGui.QApplication.translate("Dialog", "Encrypt", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBoxSource.setTitle(QtGui.QApplication.translate("Dialog", "Source", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButtonTextSource.setText(QtGui.QApplication.translate("Dialog", "Text", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButtonFileSource.setText(QtGui.QApplication.translate("Dialog", "File", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("Dialog", "Keys", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonGenKeys.setText(QtGui.QApplication.translate("Dialog", "Generate all keys", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonGenAes.setText(QtGui.QApplication.translate("Dialog", "Generate AES", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonGenOwnRsa.setText(QtGui.QApplication.translate("Dialog", "Generate own RSA", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonGenResRsa.setText(QtGui.QApplication.translate("Dialog", "Generate Sender/Receiver RSA", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonSwitchRsa.setText(QtGui.QApplication.translate("Dialog", "Switch own <> Sender/Receiver", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabTools), QtGui.QApplication.translate("Dialog", "Tools", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBoxOwnAes.setTitle(QtGui.QApplication.translate("Dialog", "Own AES", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBoxResAes.setTitle(QtGui.QApplication.translate("Dialog", "Sender / Receiver AES", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRsa), QtGui.QApplication.translate("Dialog", "RSA", None, QtGui.QApplication.UnicodeUTF8))
        self.ButtonFileSelect.setText(QtGui.QApplication.translate("Dialog", "Select File", None, QtGui.QApplication.UnicodeUTF8))
        self.labelSelectedFile.setText(QtGui.QApplication.translate("Dialog", "(no file selected)", None, QtGui.QApplication.UnicodeUTF8))
